...
% Load file SU 
%--------------
KC3_01_SU = csvread('03_SeleksiFitur\KC3_SU\KC3_SU.csv');
...
%-------------
k = 5;
vektorKC3 = KC3_01_SU(:,1);
cvFolds = crossvalind('Kfold', vektorKC3, k);
clear vektorKC3; 
    
disp('KC3_SU Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(KC3_01_SU,1)  %Iterasi baris data 
            %---- TRAINING
            if KC3_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                KC3_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = KC3_01_SU(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                KC3_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = KC3_01_SU(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "KC3_01_SU"
            ...
            %---- TESTING
                ...
                KC3_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = KC3_01_SU(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                KC3_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = KC3_01_SU(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "KC3_01_SU"
...
KC3_57_MAX_Mean_BAL = [urutan nilai size(KC3_01_SU,2)-1 toc seed]; %Simpan ke 'KC3_57_MAX_Mean_BAL'
clear nilai urutan;
...
disp('Saving...');
    tic
        save('04_CBC\KC3_SU_CBC_FOLD_5.mat');        
    toc
disp('Done!');
